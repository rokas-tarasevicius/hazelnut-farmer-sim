...
export function StatsBar() {
  ...
  const growingCount = useGameStore((s) =>
    s.grid.flat().filter((t) => t.state === 'planted').length
  );
  ...
  return (
    <div className={styles.bar}>
      ...
      <div className={styles.stats}>
        ...
        <div className={styles.stat}>
          <span className={styles.statLabel}>Growing:</span>
          <span className={styles.statValue}>{growingCount}</span>
        </div>
        <div className={styles.stat}>
